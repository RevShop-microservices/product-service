    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Seller/Admin role requirements for mutations
                .requestMatchers(HttpMethod.POST, "/api/products/**").hasAnyRole("SELLER", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/products/*/reduce-stock", "/api/products/*/increase-stock").authenticated()
                ...
                .requestMatchers("/api/seller/analytics/**").hasAnyRole("SELLER", "ADMIN")
